...
usageExample="Usage example: clean-rebuild-qt-cmake-mac.sh ~/dev/qt-dev ~/dev/qt-dev-debug ../configs/mac-debug.txt qtbase,qtsvg,qtshadertools,qtdeclarative"
...
export LLVM_INSTALL_DIR=/usr/local/libclang-20.1.0
